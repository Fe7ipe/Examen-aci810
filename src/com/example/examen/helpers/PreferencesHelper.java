package com.example.examen.helpers;

public class PreferencesHelper {

	public final static String IS_REGISTERES_KEY = "com.example.examen.IS_REGISTERES_KEY";
	public final static String IS_LOGGED_IN_KEY = "com.example.examen.IS_LOGGED_IN_KEY";
